...
class TranslationsEn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$landing$en landing = _Translations$landing$en._(_root);
...
// Path: landing
class _Translations$landing$en extends Translations$landing$es {
	_Translations$landing$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override late final _Translations$landing$nav$en nav = _Translations$landing$nav$en._(_root);
	@override String get signIn => 'Sign in';
	@override String get openApp => 'Open Agora';
	@override String get betaBadge => 'In testing';
	@override String get backToTop => 'Back to top';
	@override late final _Translations$landing$hero$en hero = _Translations$landing$hero$en._(_root);
	@override late final _Translations$landing$howItWorks$en howItWorks = _Translations$landing$howItWorks$en._(_root);
	@override late final _Translations$landing$schedules$en schedules = _Translations$landing$schedules$en._(_root);
	@override late final _Translations$landing$preview$en preview = _Translations$landing$preview$en._(_root);
	@override late final _Translations$landing$features$en features = _Translations$landing$features$en._(_root);
	@override late final _Translations$landing$privacy$en privacy = _Translations$landing$privacy$en._(_root);
	@override late final _Translations$landing$downloads$en downloads = _Translations$landing$downloads$en._(_root);
	@override late final _Translations$landing$footer$en footer = _Translations$landing$footer$en._(_root);
}
...
// Path: landing.nav
class _Translations$landing$nav$en extends Translations$landing$nav$es {
	_Translations$landing$nav$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get howItWorks => 'How it works';
	@override String get schedules => 'Timing';
	@override String get privacy => 'Your data';
	@override String get downloads => 'Downloads';
}

// Path: landing.hero
class _Translations$landing$hero$en extends Translations$landing$hero$es {
	_Translations$landing$hero$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'You type the names. That\'s it.';
	@override String get subtitle => 'Agora works out the timing and leaves you a print-ready PDF.';
	@override String get cta => 'Try it now';
	@override String get note => 'No account. Nothing to install.';
}

// Path: landing.howItWorks
class _Translations$landing$howItWorks$en extends Translations$landing$howItWorks$es {
	_Translations$landing$howItWorks$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Three steps.';
	@override String get step1Title => 'Pick the weeks';
	@override String get step1Body => 'The workbook is already downloaded, parts and songs included.';
	@override String get step2Title => 'Type the names';
	@override String get step2Body => 'Type the first letters and pick.';
	@override String get step3Title => 'Print it';
	@override String get step3Body => 'Save the PDF or share it.';
}

// Path: landing.schedules
class _Translations$landing$schedules$en extends Translations$landing$schedules$es {
	_Translations$landing$schedules$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Stop adding up minutes by hand.';
	@override String get body => 'Change one part and every time below shifts on its own.';
	@override String get circuit => 'Circuit overseer visiting? Mark it and the program reorders.';
	@override String get slack => '26 min left over · 8·8·10 to the songs';
	@override String get sampleLabel => 'Normal week · starts 6:00 p.m.';
	@override String get sampleTargetEnd => '19:45';
	@override String get sampleOpeningSong => 'Song and prayer';
	@override String get sampleIntro => 'Opening comments';
	@override String get sampleTreasures => 'Treasures From God\'s Word';
	@override String get sampleTreasuresDuration => '25 min';
	@override String get sampleMinistry => 'Apply Yourself to the Field Ministry';
	@override String get sampleMinistryDuration => '15 min fixed';
	@override String get sampleSong2 => 'Song';
	@override String get sampleChristianLife => 'Living as Christians';
	@override String get sampleChristianLifeDuration => '5 min';
	@override String get sampleBibleStudy => 'Congregation Bible study';
	@override String get sampleClosingWords => 'Concluding comments';
	@override String get sampleClosingSong => 'Song and prayer';
}

// Path: landing.preview
class _Translations$landing$preview$en extends Translations$landing$preview$es {
	_Translations$landing$preview$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'The preview doesn\'t look like the PDF. It is the PDF.';
	@override String get point1Title => 'Long names fit';
	@override String get point1Body => 'The column widens on its own.';
	@override String get point2Title => 'Two weeks on one sheet';
	@override String get point2Body => 'Without shrinking the type.';
	@override String get point3Title => 'The auxiliary classroom, alongside';
	@override String get point3Body => 'On the same sheet.';
}

// Path: landing.features
class _Translations$landing$features$en extends Translations$landing$features$es {
	_Translations$landing$features$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get auxRoomTitle => 'Auxiliary classroom';
	@override String get auxRoomBody => 'It stays set.';
	@override String get circuitTitle => 'Circuit overseer visit';
	@override String get circuitBody => 'It reorders itself.';
	@override String get editTitle => 'Change whatever you like';
	@override String get editBody => 'Type over it and you\'re done.';
	@override String get gapsTitle => 'It flags the gaps';
	@override String get gapsBody => 'If a week was left half-done.';
}

// Path: landing.privacy
class _Translations$landing$privacy$en extends Translations$landing$privacy$es {
	_Translations$landing$privacy$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Your data, wherever you say.';
	@override String get modeSolo => 'On your own';
	@override String get modeTeam => 'As a team';
	@override String get accountLabel => 'Account';
	@override String get accountSolo => 'Not needed';
	@override String get accountTeam => 'One per congregation';
	@override String get whereLabel => 'Where it lives';
	@override String get whereSolo => 'Only on this device';
	@override String get whereTeam => 'Here and in the cloud';
	@override String get whoSeesLabel => 'Who sees it';
	@override String get whoSeesSolo => 'Only you';
	@override String get whoSeesTeam => 'You and whoever you invite';
	@override String get offlineLabel => 'Without internet';
	@override String get offlineSolo => 'Works the same';
	@override String get offlineTeam => 'Catches up when you\'re back';
	@override String get soloWarning => 'The password can\'t be recovered. If you lose it, whatever\'s on this device is lost with it. Back up now and then.';
	@override String get teamNote => 'Everything in the cloud is encrypted. But a copy of the key stays on the server so you can sign in from another device.';
}

// Path: landing.downloads
class _Translations$landing$downloads$en extends Translations$landing$downloads$es {
	_Translations$landing$downloads$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Try it now. The apps are on their way.';
	@override String get body => 'The browser version already works.';
	@override String get cta => 'Open Agora now';
	@override String get comingSoonBadge => 'Coming soon';
	@override String get comingSoonBody => 'Android, iPhone, iPad, Mac and Windows.';
	@override String get storeGooglePlayName => 'Google Play';
	@override String get storeGooglePlayPlatforms => 'Android';
	@override String get storeAppStoreName => 'App Store';
	@override String get storeAppStorePlatforms => 'iPhone and iPad';
	@override String get storeMacAppStoreName => 'Mac App Store';
	@override String get storeMacAppStorePlatforms => 'macOS';
	@override String get storeMicrosoftStoreName => 'Microsoft Store';
	@override String get storeMicrosoftStorePlatforms => 'Windows';
}

// Path: landing.footer
class _Translations$landing$footer$en extends Translations$landing$footer$es {
	_Translations$landing$footer$en._(TranslationsEn root) : this._root = root, super.internal(root);

	final TranslationsEn _root; // ignore: unused_field

	// Translations
	@override String get legal => 'Independent tool. Not affiliated with the Watch Tower Bible and Tract Society of Pennsylvania or any related entity, and does not represent them.';
	@override String get license => 'The code is visible on GitHub, but it isn\'t free software: it can be viewed and used for noncommercial purposes (PolyForm Noncommercial 1.0.0). Made by Vicente Nevárez Treviño.';
	@override String get linksLabel => 'Links';
	@override String get linkRepo => 'Repository on GitHub';
}
...
extension on TranslationsEn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'landing.nav.schedules' => 'Timing',
			'landing.nav.privacy' => 'Your data',
			'landing.nav.downloads' => 'Downloads',
			'landing.signIn' => 'Sign in',
			'landing.openApp' => 'Open Agora',
			'landing.betaBadge' => 'In testing',
			'landing.backToTop' => 'Back to top',
			'landing.hero.title' => 'You type the names. That\'s it.',
			'landing.hero.subtitle' => 'Agora works out the timing and leaves you a print-ready PDF.',
			'landing.hero.cta' => 'Try it now',
			'landing.hero.note' => 'No account. Nothing to install.',
			'landing.howItWorks.title' => 'Three steps.',
			'landing.howItWorks.step1Title' => 'Pick the weeks',
			'landing.howItWorks.step1Body' => 'The workbook is already downloaded, parts and songs included.',
			'landing.howItWorks.step2Title' => 'Type the names',
			'landing.howItWorks.step2Body' => 'Type the first letters and pick.',
			'landing.howItWorks.step3Title' => 'Print it',
			'landing.howItWorks.step3Body' => 'Save the PDF or share it.',
			'landing.schedules.title' => 'Stop adding up minutes by hand.',
			'landing.schedules.body' => 'Change one part and every time below shifts on its own.',
			'landing.schedules.circuit' => 'Circuit overseer visiting? Mark it and the program reorders.',
			'landing.schedules.slack' => '26 min left over · 8·8·10 to the songs',
			'landing.schedules.sampleLabel' => 'Normal week · starts 6:00 p.m.',
			'landing.schedules.sampleTargetEnd' => '19:45',
			_ => null,
		} ?? switch (path) {
			'landing.schedules.sampleOpeningSong' => 'Song and prayer',
			'landing.schedules.sampleIntro' => 'Opening comments',
			'landing.schedules.sampleTreasures' => 'Treasures From God\'s Word',
			'landing.schedules.sampleTreasuresDuration' => '25 min',
			'landing.schedules.sampleMinistry' => 'Apply Yourself to the Field Ministry',
			'landing.schedules.sampleMinistryDuration' => '15 min fixed',
			'landing.schedules.sampleSong2' => 'Song',
			'landing.schedules.sampleChristianLife' => 'Living as Christians',
			'landing.schedules.sampleChristianLifeDuration' => '5 min',
			'landing.schedules.sampleBibleStudy' => 'Congregation Bible study',
			'landing.schedules.sampleClosingWords' => 'Concluding comments',
			'landing.schedules.sampleClosingSong' => 'Song and prayer',
			'landing.preview.title' => 'The preview doesn\'t look like the PDF. It is the PDF.',
			'landing.preview.point1Title' => 'Long names fit',
			'landing.preview.point1Body' => 'The column widens on its own.',
			'landing.preview.point2Title' => 'Two weeks on one sheet',
			'landing.preview.point2Body' => 'Without shrinking the type.',
			'landing.preview.point3Title' => 'The auxiliary classroom, alongside',
			'landing.preview.point3Body' => 'On the same sheet.',
			'landing.features.auxRoomTitle' => 'Auxiliary classroom',
			'landing.features.auxRoomBody' => 'It stays set.',
			'landing.features.circuitTitle' => 'Circuit overseer visit',
			'landing.features.circuitBody' => 'It reorders itself.',
			'landing.features.editTitle' => 'Change whatever you like',
			'landing.features.editBody' => 'Type over it and you\'re done.',
			'landing.features.gapsTitle' => 'It flags the gaps',
			'landing.features.gapsBody' => 'If a week was left half-done.',
			'landing.privacy.title' => 'Your data, wherever you say.',
			'landing.privacy.modeSolo' => 'On your own',
			'landing.privacy.modeTeam' => 'As a team',
			'landing.privacy.accountLabel' => 'Account',
			'landing.privacy.accountSolo' => 'Not needed',
			'landing.privacy.accountTeam' => 'One per congregation',
			'landing.privacy.whereLabel' => 'Where it lives',
			'landing.privacy.whereSolo' => 'Only on this device',
			'landing.privacy.whereTeam' => 'Here and in the cloud',
			'landing.privacy.whoSeesLabel' => 'Who sees it',
			'landing.privacy.whoSeesSolo' => 'Only you',
			'landing.privacy.whoSeesTeam' => 'You and whoever you invite',
			'landing.privacy.offlineLabel' => 'Without internet',
			'landing.privacy.offlineSolo' => 'Works the same',
			'landing.privacy.offlineTeam' => 'Catches up when you\'re back',
			'landing.privacy.soloWarning' => 'The password can\'t be recovered. If you lose it, whatever\'s on this device is lost with it. Back up now and then.',
			'landing.privacy.teamNote' => 'Everything in the cloud is encrypted. But a copy of the key stays on the server so you can sign in from another device.',
			'landing.downloads.title' => 'Try it now. The apps are on their way.',
			'landing.downloads.body' => 'The browser version already works.',
			'landing.downloads.cta' => 'Open Agora now',
			'landing.downloads.comingSoonBadge' => 'Coming soon',
			'landing.downloads.comingSoonBody' => 'Android, iPhone, iPad, Mac and Windows.',
			...
			'landing.downloads.storeAppStorePlatforms' => 'iPhone and iPad',
			...
			'landing.footer.legal' => 'Independent tool. Not affiliated with the Watch Tower Bible and Tract Society of Pennsylvania or any related entity, and does not represent them.',
			'landing.footer.license' => 'The code is visible on GitHub, but it isn\'t free software: it can be viewed and used for noncommercial purposes (PolyForm Noncommercial 1.0.0). Made by Vicente Nevárez Treviño.',
			'landing.footer.linksLabel' => 'Links',
			'landing.footer.linkRepo' => 'Repository on GitHub',
